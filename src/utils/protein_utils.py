...
def preprocess_unbound_bound(unbound_ligand_residues, unbound_receptor_residues, \
   ...
   #########################
    ...
    unbound_predic_ligand_filtered = filter_residues(unbound_ligand_residues)
    ...
    unbound_predic_receptor_filtered = filter_residues(unbound_receptor_residues)
   ...
   ####################
    ...
    if not inference:
        ...
        if active_ligand.size <= 1: # We need: active_ligand.size > 0 '
