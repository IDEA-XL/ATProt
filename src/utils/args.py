...
parser.add_argument('-esm', default=True)

parser.add_argument('-debug', default=False, action='store_true')

parser.add_argument('-log_every', default=100000, type=int, required=False, help='log frequency during training')
parser.add_argument('-random_seed', type=int, required=False, default=80, help='random seed')
...
parser.add_argument('-num_epochs', type=int, default=3, required=False, help="Used when splitting data for horovod.")
...
parser.add_argument('-reg', default=True, action='store_true')
parser.add_argument('-bs', type=int, default=4, required=False)
# parser.add_argument('-feat_norm', default=True, action='store_true')
parser.add_argument('-lr', type=float, default=4e-4, required=False)
...
parser.add_argument('-bern_k', type=int, default=5, required=False)    
parser.add_argument('-cls_mul', default=True, action='store_true')
parser.add_argument('-mu_r_norm', default=True, action='store_true')
parser.add_argument('-res_feat', default=True, action='store_true')
parser.add_argument('-dp_encoder', type=float, default=0.1, required=False)
parser.add_argument('-dp_cls', type=float, default=0., required=False)
parser.add_argument('-sampling', default=True, action='store_true')
...
parser.add_argument('-layer_norm', type=str, default='BN', choices=['0', 'BN', 'LN'])
...
parser.add_argument('-iegmn_lay_hid_dim', type=int, default=32, required=False)
...
parser.add_argument('-use_only_esm', default=False, action='store_true')
...
def get_model_name(args):
    ...
    model_name = model_name + str(currentDateAndTime.strftime("%H:%M:%S")) + 'reg=' + str(args['reg'])
    return model_name
########################################
...
args['cache_path'] = '../cache_esmfold/' + args['data'] + '_' + args['graph_nodes'] + '_maxneighbor_' + \
